...
class DB_Helper {
  ...
  Future<FutureOr<void>> onCreate(Database db, int version) async {
    ...
    String sqlCard =
        'create table CARD(id INTEGER KEY, materia varchar(100), titulo varchar(100), descricao TEXT, imagem TEXT);';
    ...
    sqlCard =
        "INSERT INTO CARD(materia, titulo, descricao, imagem) VALUES ('MATEMÁTICA', 'geometria plana', 'a geometria estuda a formas geométricas, e calcula a área e o volume', 'https://sites.google.com/site/victorialacerdameninadavila/_/rsrc/1386518443445/home/matematica/geometria-plana/aprenda-a-geometria-espacial.jpg');";
    await db.execute(sqlCard);
